...
class PhysicalVisit extends StatefulWidget {
  ...
  @override
  State<PhysicalVisit> createState() => _PhysicalVisitState();
}

class _PhysicalVisitState extends State<PhysicalVisit> {
  ...
  Future _findAppointment() async {
    ...
    try {
      ...
      final uid = user!.uid;
      await firestore.collection('physical_visit_server').add({
        'patient_uid': uid,
